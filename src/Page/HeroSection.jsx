...
import bckgrndImg from "../Assets/pexels-photo-247599.jpeg"
      ...
      <div className="hero-contentWrapper">
        ...
        <div className="hero-footerSection">
          ...
          <div className="sponsors">
            ...
            <img src={greenpeace} alt="Greenpeace logo" className="logo" />
      ...
      <div className="hero-backgroundImgWrapper">
        ...
        <div className="imageContainer">
          <img
            loading="lazy"
            src={bckgrndImg}
            alt="Scenic rice paddy view in the background Photo by Pixabay"
          />
        </div>
      </div>
    </div>
