...
function Body() {
  ...
  return (
    <div className="bodyWrapper">
      <div className="insight" data-aos="fade-up">
      ...
      <div className="cardWrapper">
        {cardData.map((x) => {
          ...
          return (
            <div className="card" id={id} data-aos="fade-up">
      ...
      <div className="testimonialWrapper">
        {testimonialCards.map((x) => {
          ...
          return (
            <div className="t-cards" key={id} data-aos="fade-up">
              ...
              <p className="t-comments">{comment}</p>
      ...
      <div className="joinWrapper" data-aos="fade-up">
        ...
        <div className="join-contentWrapper" data-aos="fade-up">
