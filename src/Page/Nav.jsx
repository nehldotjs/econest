  ...
  return (
    <div className="nav">
      <div className="nav-wrapper">
        <div className="nav-logoWrapper">
          ...
          <div className="mobileMenuBtn">
            <button onClick={() => setIsAnim(!isAnim)} type="button">
              <div
                className={
                  !isAnim ? "before" : " before beforeAnimation"
                }></div>
              <div
                className={
                  !isAnim ? "center" : " center centerAnimation"
                }></div>
              <div className={!isAnim ? "after" : "after afterAnimation"}></div>
            </button>
          </div>
        </div>

        <div className="nav-linkBtnWrapper">
          <button className="navBtnLinks">Manifesto</button>
          <button className="navBtnLinks">Issues</button>
          <button className="navBtnLinks">Library</button>
          <button className="navBtnLinks">Contacts</button>
        </div>
      ...
      <div
        ...
        className={
          isAnim ? "mobileBurgerMenu" : "mobileBurgerMenu mobileBurgerMenuAnim"
        }>
        <div className="menuLinkBtn">
          <button className="mobileLinkBtn">Manifesto</button>
          <button className="mobileLinkBtn">Issues</button>
          <button className="mobileLinkBtn">Library</button>
          <button className="mobileLinkBtn">Contacts</button>
        </div>
      </div>
    </div>
  );
